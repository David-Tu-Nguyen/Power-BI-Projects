...
- The project's background is to analyze a healthcare dataset and create a comprehensive dashboard to present the findings. [Link data](https://www.mavenanalytics.io/challenges/maven-toys-challenge?search=toy)
...
**Healthcare Provider's database structure** as seen below consists of 5 tables: with a total row count of 82,9263 records and 19 fields.
